...
namespace ComPerWorkerRole
{
    ...
    public class JsonRpcRequest
    {
        ...
        protected JsonRpcRequest(String method, JToken param)
            : this(method)
        {
            if (param != null)
            {
        ...
        public static class Factory
        {
            ...
            public static JsonRpcRequest CreateJsonRpcRequest(String method, JToken param)
            {
            ...
            public static JsonRpcRequest CreateJsonRpcNotification(String method, JToken param)
            {
                return new JsonRpcRequest(method, param);
            }
        }
